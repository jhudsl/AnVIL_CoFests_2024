...
- Build community (and be inclusive for newcomers)
- Contribute to [open science](https://en.wikipedia.org/wiki/Open_science)
- Report out a final product that accomplishes one of the following for a topic
...
- Scientific Lead and AnVIL Co-Lead for support
- We expect perhaps 4-10 participants per track

## Example Schedule for a Track {- .unlisted}

- First Day (2.5 hrs scheduled):
  - Problem statement (perhaps with a short demo) by scientific lead

    This part of the session will provide background info on the track's overall topic and may include a brief summary of the pre-worked ideas. Perhaps 20-30 minutes?
...
- Share report out during the CoFest Recap Session!  
